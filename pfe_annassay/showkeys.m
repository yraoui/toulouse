...
%function showkeys(image, locs1,locs2,locs3)
function showkeys(image, locs1)
...
for i = 1: size(locs1,1)
    ...
    TransformLine(imsize, locs1(i,:), 0.0, 0.0, 1.0, 0.0);
    TransformLine(imsize, locs1(i,:), 0.85, 0.1, 1.0, 0.0);
    TransformLine(imsize, locs1(i,:), 0.85, -0.1, 1.0, 0.0);
end
...
for i = 1: size(locs2,1)
    % Draw an arrow, each line transformed according to keypoint parameters.
    TransformLine(imsize, locs2(i,:), 0.0, 0.0, 1.0, 0.0);
    TransformLine(imsize, locs2(i,:), 0.85, 0.1, 1.0, 0.0);
    TransformLine(imsize, locs2(i,:), 0.85, -0.1, 1.0, 0.0);
end
...
for i = 1: size(locs3,1)
    % Draw an arrow, each line transformed according to keypoint parameters.
    TransformLine(imsize, locs3(i,:), 0.0, 0.0, 1.0, 0.0);
    TransformLine(imsize, locs3(i,:), 0.85, 0.1, 1.0, 0.0);
    TransformLine(imsize, locs3(i,:), 0.85, -0.1, 1.0, 0.0);
end
% 
